...
class AkinatorCommand extends Command {
    ...
    async execute(msg, args) {
        ...
        try {
			...
			msg.channel.createMessage('<:konataowo:710900227887857704> **|** Guessed right one more time! I love playing with you! Have some cake. :cake:');
        } catch(err) {
			this.games.delete(msg.channel.id);
			msg.channel.createMessage(`<:konatacry:710895046492160080> **|** An error has occured! \`\`\`js\n${err.stack}\`\`\`. Try again later~`);
        }
	}
