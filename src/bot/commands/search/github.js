...
class GithubCommand extends Command {
    ...
    async execute(msg, args) {
        if (!args[0]) return msg.channel.createMessage(`<:KonataYawn:710895044831477774> **|** Invalid usage, do \`${this.bot.config.prefix}help github\`.`);
        const m = await msg.channel.createMessage(`<:konataok:710895044902649996> **|** Fetching \`${args[0]}/${args[1]}\`.`);
