...
class HexToIntCommand extends Command {
    ...
    async execute(msg, args) {
        if (!args[0]) return msg.channel.createMessage('<:OwOThink:439675032910954496> **|** Provide a hex color.');
        ...
        msg.channel.createMessage(`<:OwOThink:439675032910954496> **|** The integer version of \`#${args[0]}\` is: \`${parseInt(`0x${args[0]}`)}\`.`);
    }
}
